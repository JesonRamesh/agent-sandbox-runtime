...
// Inbound event shapes left as `any` — fully typed in T12.
interface Props {
  wsStatus: 'connected' | 'disconnected' | string;
  llmEvents?: any[];
  kernelEvents?: any[];
}

export default function Header({ wsStatus, llmEvents, kernelEvents }: Props) {
