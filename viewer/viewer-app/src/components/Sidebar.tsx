import './Sidebar.css';
import type { LLMEvent, KernelEvent, Stats } from '../types/events';
...
function AgentStatusDot({ events }: { events: LLMEvent[] }) {
...
function AgentStatusLabel({ events }: { events: LLMEvent[] }) {
