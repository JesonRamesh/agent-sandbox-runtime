...
function isoToEpochSeconds(iso: unknown): number {
...
function agentLabel(agentId: string | null | undefined, names: Map<string, string>): string {
...
// keep them in sync.
function pillarOf(kind: string): string {
  switch (kind) {
...
function uiTypeFor(pillar: string, verdict: string): string {
...
function buildKernelData(kind: string, details: any) {
...
function transformDaemonEvent(raw: any, names: Map<string, string>) {
